if shared.VapeExecuted then
	...
	local customdir = (shared.VapePrivate and "coffeeprivate/" or "coffee/")
	...
	local api = {
		...
		["RainbowSpeed"] = 0.6,
		["Language"] = betterisfile("coffee/language.dat") and readfile("coffee/language.dat") or "en-us",
	...
	local function GetURL(scripturl)
		if shared.VapeDeveloper then
			if not betterisfile("coffee/"..scripturl) then
				error("File not found : coffee/"..scripturl)
			end
			return readfile("coffee/"..scripturl)
		else
			local res = game:HttpGet("https://raw.githubusercontent.com/supercellgamer/Coffee-Client/main/"..scripturl, true)
	...
	searchbaricon.Image = getcustomassetfunc("coffee/assets/SearchBarIcon.png")
	...
	searchbarshadow.Image = getcustomassetfunc("coffee/assets/WindowBlur.png")
	...
	hoverboxshadow.Image = getcustomassetfunc("coffee/assets/WindowBlur.png")
	...
	api["LoadSettings"] = function(customprofile)
		...
		if betterisfile("coffee/Profiles/GUIPositions.vapeprofile.txt") and game.GameId == 2619619496 then
			writefile("coffee/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt", readfile("coffee/Profiles/GUIPositions.vapeprofile.txt"))
			if delfile then delfile("coffee/Profiles/GUIPositions.vapeprofile.txt") end
		end
		if shared.VapePrivate then
			if betterisfile("coffeeprivate/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") == false and betterisfile("coffee/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt") then
				writefile("coffeeprivate/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt", readfile("coffee/Profiles/"..(game.GameId).."GUIPositions.vapeprofile.txt"))
			end
			if betterisfile("coffeeprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") == false and betterisfile("coffee/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt") then
				writefile("coffeeprivate/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt", readfile("coffee/Profiles/"..(shared.CustomSaveVape or game.PlaceId)..".vapeprofiles.txt"))
			end
			if betterisfile("coffeeprivate/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") == false and betterisfile("coffee/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt") then
				writefile("coffeeprivate/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt", readfile("coffee/Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveVape or game.PlaceId)..".vapeprofile.txt"))
			end
		end
	...
	api["CreateMainWindow"] = function()
		...
		windowshadow.Image = getcustomassetfunc("coffee/assets/WindowBlur.png")
		...
		windowlogo1.Image = getcustomassetfunc(translatedlogo and "coffee/translations/"..api["Language"].."/VapeLogo1.png" or "coffee/assets/VapeLogo1.png")
		...
		windowlogo2.Image = getcustomassetfunc("coffee/assets/VapeLogo2.png")
		...
		settingswheel.Image = getcustomassetfunc("coffee/assets/SettingsWheel1.png")
		...
		discordbutton.Image = getcustomassetfunc("coffee/assets/DiscordIcon.png")
		...
		settingsexit.Image = getcustomassetfunc("coffee/assets/ExitIcon1.png")
		...
		overlaysicon.Image = getcustomassetfunc("coffee/assets/TextGUIIcon4.png")
		...
		overlaysexit.Image = getcustomassetfunc("coffee/assets/ExitIcon1.png")
		...
		overlaysbutton.Image = getcustomassetfunc("coffee/assets/TextGUIIcon2.png")
		...
		windowbackbutton.Image = getcustomassetfunc("coffee/assets/BackIcon.png")
		...
		windowapi["CreateDivider2"] = function(text)
			...
			if text then
				...
				arrow.Image = getcustomassetfunc("coffee/assets/RightArrow.png")
				arrow.Active = false
				arrow.Parent = button
				...
				windowbackbutton2.Image = getcustomassetfunc("coffee/assets/BackIcon.png")
				...
				windowapi3["CreateToggle"] = function(argstable)
					...
					buttonarrow.Image = getcustomassetfunc("coffee/assets/ToggleArrow.png")
				...
				windowapi3["CreateSlider"] = function(argstable)
					...
					slider3.Image = getcustomassetfunc("coffee/assets/SliderButton1.png")
		...
		windowapi["CreateGUIBind"] = function()
			...
			bindimg.Image = getcustomassetfunc("coffee/assets/KeybindIcon.png")
			...
			bindtext2.Image = getcustomassetfunc("coffee/assets/BindBackground.png")
			...
			bindbkg.MouseEnter:connect(function() 
				bindimg.Image = getcustomassetfunc("coffee/assets/PencilIcon.png") 
		...
		windowapi["CreateColorSlider"] = function(name, temporaryfunction)
			...
			sliderrainbow.Image = getcustomassetfunc("coffee/assets/RainbowIcon1.png")
			...
			slider3.BorderSizePixel = 0
			slider3.ZIndex = 2
			slider3.Image = getcustomassetfunc("coffee/assets/ColorSlider1.png")
			...
			sliderapi["SetValue"] = function(val)
				slider3.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("coffee/assets/ColorSlider2.png") or getcustomassetfunc("coffee/assets/ColorSlider1.png"))
				sliderrainbow.Image = (sliderapi["RainbowValue"] and getcustomassetfunc("coffee/assets/RainbowIcon2.png") or getcustomassetfunc("coffee/assets/RainbowIcon1.png"))
	...
	api["CreateCustomWindow"] = function(argstablemain)
		...
		expandbutton.Image = getcustomassetfunc("coffee/assets/PinButton.png")
		...
		optionsbutton.Image = getcustomassetfunc("coffee/assets/MoreButton3.png")
		...
		windowapi["CreateCircleWindow"] = function(argstablemain3)
			...
			targeticon.Image = getcustomassetfunc("coffee/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			targeticon.ZIndex = 2
			...
			windowicon.Image = getcustomassetfunc("coffee/assets/CircleList"..(argstablemain3["Type"] == "Blacklist" and "Blacklist" or "Whitelist")..".png")
			...
			windowapi3["CreateCircleTextList"] = function(argstable)
				...
				textboxbkg.Image = getcustomassetfunc((argstable["Name"] == "ProfilesList" and "coffee/assets/TextBoxBKG2.png" or "coffee/assets/TextBoxBKG.png"))
				...
				textapi["RefreshValues"] = function(tab, tab2)
					...
					for i,v in pairs(textapi["ObjectList"]) do
						...
						deletebutton.Image = getcustomassetfunc("coffee/assets/AddRemoveIcon1.png")
		...
		windowapi["CreateDropdown"] = function(argstable)
			...
			expandbutton2.Image = getcustomassetfunc("coffee/assets/DownArrow.png")
			...
			drop2.ExpandButton2.Image = getcustomassetfunc("coffee/assets/UpArrow.png")
			local thing = Instance.new("Frame")
			thing.Size = UDim2.new(1, 2, 1, 2)
			thing.BorderSizePixel = 0
			thing.Position = UDim2.new(0, -1, 0, -1)
	...
	api["CreateWindow"] = function(argstablemain2)
		...
		expandbutton2.Active = false
		expandbutton2.Size = UDim2.new(0, 9, 0, 4)
		expandbutton2.Image = getcustomassetfunc("coffee/assets/UpArrow.png")
		...
		windowapi["CreateOptionsButton"] = function(argstablemain)
			...
			button2.Image = getcustomassetfunc("coffee/assets/MoreButton1.png")
		...
		--	children2.LayoutOrder = amount
			...
			buttonapi["ToggleButton"] = function(clicked, toggle)
				...
				if buttonapi["Enabled"] then
					...
					button2.Image = getcustomassetfunc("coffee/assets/MoreButton2.png")
			...
			buttonapi["CreateTextList"] = function(argstable)
				...
				textboxbkg.Position = UDim2.new(0, 10, 0, 5)
				textboxbkg.ClipsDescendants = true
				textboxbkg.Image = getcustomassetfunc("coffee/assets/TextBoxBKG.png")
				textboxbkg.Parent = frame
				local textbox = Instance.new("TextBox")
				textbox.Size = UDim2.new(0, 159, 1, 0)
				textbox.Position = UDim2.new(0, 11, 0, 0)
			...
			buttonapi["CreateTargetWindow"] = function(argstablemain3)
				...
				local windowicon = Instance.new("ImageLabel")
				windowicon.Size = UDim2.new(0, 18, 0, 16)
				windowicon.Image = getcustomassetfunc("coffee/assets/TargetIcon.png")
				windowicon.ImageColor3 = Color3.fromRGB(200, 200, 200)
				windowicon.ZIndex = 3
				windowicon.Name = "WindowIcon"
				windowicon.BackgroundTransparency = 1
				...
				buttonreturned["NPCs"] = windowapi["CreateButton"]({
					...
					["Icon"] = "coffee/assets/TargetIcon2.png",
					["IconSize"] = 12,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Peaceful"] = windowapi["CreateButton"]({
					...
					["Icon"] = "coffee/assets/TargetIcon3.png",
					["IconSize"] = 16,
					["Function"] = function() end,
					["Default"] = false
				})
				buttonreturned["Neutral"] = windowapi["CreateButton"]({
					...
					["Icon"] = "coffee/assets/TargetIcon4.png",
					["IconSize"] = 19,
					["Function"] = function() end,
					["Default"] = false
				})
			...
			buttonapi["CreateColorSlider"] = function(argstable)
				...
				sliderexpand.Image = getcustomassetfunc("coffee/assets/HoverArrow3.png")
				sliderexpand.Parent = frame
				sliderexpand.MouseEnter:connect(function()
					sliderexpand.Image = getcustomassetfunc("coffee/assets/HoverArrow4.png")
				end)
			...
			buttonapi["CreateTwoSlider"] = function(argstable)
				...
				text4.Image = getcustomassetfunc("coffee/assets/SliderArrowSeperator.png")
				...
				slider3.BackgroundColor3 = Color3.fromRGB(26, 25, 26)
				slider3.BorderSizePixel = 0
				slider3.Image = getcustomassetfunc("coffee/assets/SliderArrow1.png")
	...
	api["CreateWindow2"] = function(argstablemain)
		...
		settingsbutton.Image = getcustomassetfunc("coffee/assets/SettingsWheel2.png")
		...
		windowapi["CreateColorSlider"] = function(argstable)
			...
			sliderexpand.BackgroundTransparency = 1
			sliderexpand.Position = UDim2.new(0, game:GetService("TextService"):GetTextSize(text1.Text, text1.TextSize, text1.Font, Vector2.new(10000, 100000)).X + 3, 0, 6)
			sliderexpand.Image = getcustomassetfunc("coffee/assets/HoverArrow.png")
			sliderexpand.Parent = frame
			sliderexpand.MouseEnter:connect(function()
				sliderexpand.Image = getcustomassetfunc("coffee/assets/HoverArrow2.png")
			end)
			sliderexpand.MouseLeave:connect(function()
				sliderexpand.Image = getcustomassetfunc("coffee/assets/HoverArrow.png")
			end)
	...
	api["CreateNotification"] = function(top, bottom, duration, customicon)
		...
		image.Image = getcustomassetfunc("coffee/assets/NotificationBackground.png")
		...
		frame2.ZIndex = 2
		frame2.Image = getcustomassetfunc("coffee/assets/NotificationBar.png")
		frame2.BorderSizePixel = 0
		frame2.Parent = image
		local icon = Instance.new("ImageLabel")
		icon.Name = "IconLabel"
		icon.Image = getcustomassetfunc(customicon and "coffee/"..customicon or "coffee/assets/InfoNotification.png")
